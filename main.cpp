/*
 * GLUT Garaphics Projet
 *
 * Written by Nikhil Nandan and Laraib Khan
 *
 * This program is to display the effective lane management.
 *
 *
 *
 *
...
glClearColor(0.0,0.0,0.00,0);/*background for cover page*/
glClear(GL_COLOR_BUFFER_BIT);
glColor3f(1,0,0);
drawstring(450.0,700.0,0.0,"BANGALORE TECHNOLOGICAL INSTITUTE ");
glColor3f(1,1,2);
drawstring(330,650,0.0,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
glColor3f(1,4,0);
drawstring(470,600,0.0,"A GRAPHICS MINI PROJECT ON");
glColor3f(1,0,1);
drawstring(530,540,0.0,"LANE MANAGEMENT");
glColor3f(1,0.5,0);
drawstring(200,400,0.0,"BY:");
glColor3f(1,1,1);
drawstring(200,350,0.0,"LARAIB KHAN                                                                                              1BH17CS032");
glColor3f(1,1,1);
drawstring(200,290,0.0,"JHA NIKHIL NANDAN PAWAN KUMAR                                                1BH17CS026");
glColor3f(1,0.5,0);
drawstring(200,220,0.0,"GUIDES:");
glColor3f(1,1,1);
drawstring(200,180,0.0,"MR. ROHITH VAIDYA");
...
glClear(GL_COLOR_BUFFER_BIT);
glColor3f(0,1,0);
drawstring(550.0,700.0,0.0,"INSTRUCTIONS");

glColor3f(0.5,0.1,0.9);
drawstring(250.0,640.0,0.0,"Stop the traffic (Red Signal)                                            MOUSE LEFT CLICK");
glColor3f(0.5,0.1,0.9);
drawstring(250.0,540.0,0.0,"Yellow Signal                                                                   MOUSE RIGHT BUTTON (HOLD ON)");
glColor3f(0.5,0.1,0.9);
drawstring(250.0,440.0,0.0,"Green Signal                                                                    MOUSE RIGHT BUTTON (RELEASE)");
glColor3f(0.5,0.1,0.9);
drawstring(250.0,340.0,0.0,"Allow vehicles which are on LEFT to MOVE               PRESS 'L'");
glColor3f(0.5,0.1,0.9);
drawstring(250.0,240.0,0.0,"Allow vehicles which are on RIGHT to MOVE            PRESS 'R'");
glColor3f(0.5,0.1,0.9);
drawstring(250.0,140.0,0.0,"Speed up the vehicles                                                     PRESS 'S'");
glColor3f(0.5,0.1,0.9);
drawstring(250.0,90.0,0.0,"Help                                                                                PRESS 'H'");
glColor3f(0.5,0.1,0.9);
drawstring(250.0,40.0,0.0,"Escape                                                                            PRESS 'ENTER'");
glFlush();
}
...
glutCreateWindow("Lane Management");
